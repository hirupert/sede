...
local train_data = "data/spider";
local dev_data = "data/spider/dev.json";
local tables_file = "data/spider/tables.json";
...

{
    ...
    "dataset_reader": {
        ...
        "train_data_files": ["train_spider.json", "train_others.json"],
        "dataset_name": "spider",
